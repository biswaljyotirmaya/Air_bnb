  ...
  return (
    <div className="relative group">
      ...
      >
        ...
        {/* Left Arrow */}
        <div className="absolute top-[50%] left-0 transform -translate-y-1/2 -translate-x-[-30px] text-lg rounded-full bg-black/20 p-1 text-white cursor-pointer">
          <BsChevronCompactLeft onClick={prevSlide} size={20} />
        </div>
        {/* Right Arrow */}
        <div className="absolute top-[50%] right-0 transform -translate-y-1/2 translate-x-[-30px] text-lg rounded-full bg-black/20 p-1 text-white cursor-pointer">
